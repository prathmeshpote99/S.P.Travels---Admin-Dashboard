...
function Tables() {
  ...
  const deleteCustomers = async (id) => {
    ...
    if (confirmed) {
      try {
        ...
        setAlert({ visible: true, message: "Customer deleted successfully! 😮", color: "success" });
        setData(updatedData.data);
      } catch (error) {
        console.error("Error deleting data:", error);
        setAlert({ visible: true, message: "Failed to delete customer 🙁", color: "danger" });
      }
    }
    setTimeout(() => {
  ...
  return (
    <>
      <div className="alertbox_list d-flex justify-content-end align-items-center fs-6">
